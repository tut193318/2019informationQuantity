...
public class TestCase {
	...
	try {
	    ...
	    freq = myObject.frequency();
	    System.out.print("Case:When Space is not set. 仕様:0 実際:"+freq+" ->");
	    ...
	    freq = myObject.frequency();
	    System.out.print("Case:When Target is \"H\" , Space is \"Hi Ho Hi Ho\". Target appears "+freq+" times. ");
	    ...
	    freq = myObject.frequency();
	    System.out.print("Case:When Target is \"B\" , Space is \"Bike Big Ball Best Baloon\". Target appears "+freq+" times. ");
